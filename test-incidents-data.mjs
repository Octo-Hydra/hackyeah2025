...
async function checkData() {
  try {
    ...
    if (sampleIncident) {
      ...
      console.log('LineIds type:', Array.isArray(sampleIncident.lineIds) ? 'array' : typeof sampleIncident.lineIds);
      
      if (Array.isArray(sampleIncident.lineIds) && sampleIncident.lineIds.length > 0) {
