...
updateProfile?: [{	input: ValueTypes["UpdateProfileInput"] | Variable<any, string>},ValueTypes["User"]],
...
dismissJourneyNotification?: [{	id: ResolverInputTypes["ID"]},boolean | `@${string}`],
	clearJourneyNotifications?:boolean | `@${string}`,
updateProfile?: [{	input: ResolverInputTypes["UpdateProfileInput"]},ResolverInputTypes["User"]],
